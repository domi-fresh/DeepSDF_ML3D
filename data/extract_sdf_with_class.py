...
def main(cfg):
    ...
    cls_str2int_dict = dict()
    cls_int2str_dict = dict()
    ...
    for obj_idx, obj_path in enumerate(obj_paths):
        ...
        obj_cls_str = obj_idx_str.split("/")[0]
        obj_cls_idx = cls_str2int_dict[obj_cls_str]
    ...
    np.save(os.path.join(os.path.dirname(results.__file__), f'cls_str2int_dict.npy'), cls_str2int_dict)
    np.save(os.path.join(os.path.dirname(results.__file__), f'cls_int2str_dict.npy'), cls_int2str_dict)
