import torch
import model.model_sdf as siren_model
...
class Trainer():
    ...
    def __call__(self):
        ...
        self.latent_codes = utils_deepsdf.generate_latent_codes(self.train_cfg['latent_size'], samples_dict, num_latent_classes=dataset.num_latent_classes)
